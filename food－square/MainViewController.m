...
@interface MainViewController ()<MKMapViewDelegate,CLLocationManagerDelegate,UIAlertViewDelegate>
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if ([segue.identifier isEqualToString:@"DetailMain"]) {
        DetailMainViewController *detailMainViewController=segue.destinationViewController;
